...
%
\begin{enumerate}
 \item Data from RP\_CPT2 trigger were used (in our physics analyses the same data, as well as data collected in parallel with RP\_CPT2 were used). This trigger required at least 2 level-0 TOF hits (trigger details can be found in Tab.~2.1 of Ref.~\cite{AnalysisNoteRafal}). Embedded $\pi^{+}\pi^{-}$ GenEx MC sample was subjected to the same trigger conditions, except online TOF multiplicity condition to avoid trigger bias.\\[-16pt]% in the text.
 %
...
\parbox{0.4725\textwidth}{
  ...
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:sampleMissingPtTagAndProbe_DATA}}{\includegraphics[width=\linewidth,page=8]{graphics/correctionsToEff/TOF_tagAndProbe/Fitting_effVsPt_data.CPT2.pdf}\vspace{-10pt}}}
  \end{subfigure}
}
\quad
\parbox{0.4725\textwidth}{
  \centering
    \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:sampleMissingPtTagAndProbe_MC}}{\includegraphics[width=\linewidth,page=8]{graphics/correctionsToEff/TOF_tagAndProbe/Fitting_effVsPt_mc.CPT2.pdf}\vspace{-10pt}}}
  \end{subfigure}
}\vspace{-5pt}%
