...
% Title Page
\title{\textbf{Supplementary note on diffractive analyses\\of 2015 proton-proton data:\\[20pt]\large{\cite{AnalysisNoteRafal}~Measurement of diffractive Central Exclusive Production of $\bm{h\bar{h}}$\\pairs ($\bm{h=\pi,K,p}$) in proton-proton collisions at~$\bm{\sqrt{s}=}$~200~GeV\\with forward proton reconstruction in Roman Pot detectors\\[10pt]\cite{AnalysisNoteLukasz}~Measurement of particle production in diffractive proton-proton\\interactions at~$\bm{\sqrt{s}=}$~200~GeV with forward proton reconstruction\\in Roman Pot detectors\\}}\vspace*{10pt}}
