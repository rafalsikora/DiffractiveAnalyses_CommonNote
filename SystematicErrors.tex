...
\begin{minipage}{.4725\textwidth}%
  ...
  \caption[Probability of the non-zero TOF L0 multiplicity if 1 primary TOF-matched TPC track vs. track $\eta$.]
   {Probability of the non-zero trigger-level TOF multiplicity in events with only 1 primary TPC track matched with offline TOF hit, as a function of track pseudorapidity.}
...
\begin{minipage}{.4725\textwidth}%
  \centering%\vspace{11pt}
  \includegraphics[width=0.98\linewidth]{graphics/systematicsEfficiency/TOF_tagAndProbe/effSketch.pdf}%\vspace{-5pt}%
...
\begin{minipage}{.4725\textwidth}%
  ...
  \caption[Distribution of $z$-position of vertices with TPC tracks containing hits in HFT.]
   {Distribution of $z$-position of vertices with TPC tracks with hits in HFT (st\_ssd stream). Open circles represent vertices with tracks with hits either in IST or SST, full circles - IST and SST.}
...
\caption[ttt.]%
    {ttt}\label{fig:sampleMissingPtTagAndProbe}%
\end{figure}
%---------------------------
