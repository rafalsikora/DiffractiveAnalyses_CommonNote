...
%
%
 \multirow{2}{*}{TPC}   &  \specialcell{MC signal embedding\\into real data} & \multicolumn{3}{c|}{$3\%$} & \multicolumn{3}{c|}{$1.5\%$} & \multirow{2}{*}{$1.5\%$\vspace{-17pt}} &  \multirow{2}{*}{$1.8\%$\vspace{-17pt}}  &  \multirow{2}{*}{$1.8\%$\vspace{-17pt}} \\ \arrayrulecolor{lightgray} \cline{2-8} \arrayrulecolor{black}
