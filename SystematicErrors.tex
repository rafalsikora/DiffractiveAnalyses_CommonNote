...
%
%
 \multirow{3}{*}{TPC\vspace{-34pt}}   &  \specialcell{MC signal embedding\\into real data} & \multicolumn{3}{c|}{$3\%$} & \multicolumn{3}{c|}{$1.8\%$} & \multirow{2}{*}{$2.1\%$\vspace{-44pt}} &  \multirow{2}{*}{$2.3\%$\vspace{-44pt}}  &  \multirow{2}{*}{$2.3\%$\vspace{-44pt}} \\ \arrayrulecolor{lightgray} \cline{2-8} \arrayrulecolor{black}
