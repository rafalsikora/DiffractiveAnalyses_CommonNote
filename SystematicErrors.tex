...
\begin{itemize}
	\item The  spaces  between  the TPC sectors which are required to mount the wires on the sectors and fiducial cuts applied during  track reconstruction.\\[-17pt]
	\item Dead channels.\\[-17pt]
	\item Presence of off-time pile-up hits in TPC.  This results in lowering the number of hits associated with reconstructed track and track rejection caused by track quality selection.\\[-17pt]
