...
\begin{figure}[h]%\vspace{-34pt}
	...
	\parbox{0.54\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:totalRpRecoEff2D}}{\includegraphics[width=\linewidth,page=1]{graphics/systematicsEfficiency/RpSyst/totalRpRecoEff2D.pdf}\vspace{-12pt}}}
		\end{subfigure}
	\caption[Coparison of estimated RP track reconstruction efficiency in 2D and 1D.]%
	{Comparison of RP track reconstruction efficiency estimated with the described method as a function of $(p_{x},p_{y})$ of proton (\ref{fig:totalRpRecoEff2D}) and comparison of 1-dimensional projections on $p_{x}$ (\ref{fig:totalRpRecoEff1D_px}) and $p_{y}$ (\ref{fig:totalRpRecoEff1D_py}). Lower pad in each subfigure shows the difference between efficiency extracted from the data and elastic scattering MC embedded into zero-bias data.}\label{fig:wefwfwef}\vspace{60pt}%
	}
	\quad
	\parbox{0.43\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:totalRpRecoEff1D_px}}{\includegraphics[width=\linewidth,page=1]{graphics/systematicsEfficiency/RpSyst/dataTotalEff_1D.pdf}\vspace{-12pt}}}
		\end{subfigure}
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:totalRpRecoEff1D_py}}{\includegraphics[width=\linewidth,page=2]{graphics/systematicsEfficiency/RpSyst/dataTotalEff_1D.pdf}\vspace{-12pt}}}
		\end{subfigure}
	}
\end{figure}
%---------------------------
