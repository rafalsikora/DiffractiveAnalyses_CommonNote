...
\parbox{0.4725\textwidth}{
  ...
  \begin{subfigure}[b]{\linewidth}
                \subcaptionbox{\label{fig:PhiVsEta_runRange1}}{\includegraphics[width=\linewidth,page=1]{graphics/systematicsEfficiency/bbc_and/PhiVsEta.pdf}\vspace{-5pt}}\vspace{-5pt}
  \end{subfigure}
}%
\quad\quad% 
\parbox{0.4725\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}
                \subcaptionbox{\label{fig:PhiVsEta_runRange2}}{\includegraphics[width=\linewidth,page=2]{graphics/systematicsEfficiency/bbc_and/PhiVsEta.pdf}\vspace{-5pt}}\vspace{-5pt}
  \end{subfigure}
}%
