...
\begin{figure}[H]%\vspace{-2pt}%  
	...
	\begin{minipage}{.4725\textwidth}%
		...
		{Number of hits used in the helix fit $N_{\text{hits}}^{\text{fit}}$ for embedded MC samples  selected with respect to average rate in BBC. Distributions were normalized to the number of events in \mbox{$\langle\text{BBC\_AND}\rangle=700$~kHz} sample. Red line and arrow indicate the region accepted in the analysis for nominal $N_{\text{hits}}^{\text{fit}}$ cut value.}\label{fig:NhitsFitPileUp}%\vspace*{-29pt} 
	\end{minipage}%
...
\subsection{Variation in the track quality cuts}\label{Sec:TrackCutVariation}
...
\begin{figure}[h!]
	...
	\parbox{0.49\textwidth}{
		...
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_MinusPt0}}{\centering\includegraphics[width=\linewidth,page=3]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}%
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_PlusPt0}}{\centering\includegraphics[width=\linewidth,page=15]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_MinusPt1}}{\centering\includegraphics[width=\linewidth,page=4]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}%
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_PlusPt1}}{\centering\includegraphics[width=\linewidth,page=16]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}
...
\begin{figure}[h!]
	...
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_MinusEta0}}{\centering\includegraphics[width=\linewidth,page=1]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}%
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_PlusEta0}}{\centering\includegraphics[width=\linewidth,page=13]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_MinusEta1}}{\centering\includegraphics[width=\linewidth,page=2]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}%
	\parbox{0.49\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}\centering
			\subcaptionbox{\label{fig:eff_varCuts_PlusEta1}}{\centering\includegraphics[width=\linewidth,page=14]{graphics/eff/comparison_TPC.pdf}}
		\end{subfigure}
	}
...
\begin{figure}[h]%\vspace{-34pt}
	...
	\parbox{0.4725\textwidth}{
		\centering
		\includegraphics[width=\linewidth,page=1]{graphics/systematicsEfficiency/RpSyst/relativeTriggerEff2D_pxpy.pdf}%\vspace{-12pt}
	}
	\quad
	\parbox{0.4725\textwidth}{
...
%
%
 \multirow{3}{*}{TPC\vspace{-34pt}}   &  \specialcell{MC signal embedding\\into real data} & \multicolumn{3}{c|}{$2\%$} & \multicolumn{3}{c|}{$1\%$} & \multirow{2}{*}{$1.5\%$\vspace{-44pt}} &  \multirow{2}{*}{$1.7\%$\vspace{-44pt}}  &  \multirow{2}{*}{$1.7\%$\vspace{-44pt}} \\ \arrayrulecolor{lightgray} \cline{2-8} \arrayrulecolor{black}
