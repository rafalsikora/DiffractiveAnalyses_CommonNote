...
\begin{minipage}{.4725\textwidth}%
  ...
  \caption[Comparison of original and reconstructed TOF multiplicity at the trigger level.]
   {Comparison of original online TOF multiplicity at L0 (horizontal axis) and TOF multiplicity reconstructed from the offline hits (vertical axis) for RP\_CPT triggers.} % (at least 1 primary vertex with TOF-matched TPC tracks)
