...
\end{equation}
where:\\[5pt]
$\epsilon_{ TPC}^{1100, \text{nHitsFit}\geq 25}$ - TPC track reconstruction efficiency calculated from sample with \mbox{$<\text{BBC\_AND}>=1100$~kHz}\\\hspace*{70pt}with default nHitsFit quality cut,\\
