...
\parbox{0.495\textwidth}{
  \centering
%   \includegraphics[width=\linewidth,page=4]{graphics/correctionsToEff/TOF_tagAndProbe/Fitting_effVsPt_mc.CPT.pdf}
\vspace{175pt}
...
% 		\centering
% 		\includegraphics[width=\linewidth,page=1]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=15]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=30]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=41]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 	}~
% 	\parbox{0.325\textwidth}{
% 		\centering
% 		\includegraphics[width=\linewidth,page=5]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=20]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=35]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=46]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}
% 	}%
% 	\parbox{0.325\textwidth}{
% 		\centering
% 		\includegraphics[width=\linewidth,page=10]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=25]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=40]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=51]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}
% 	}%
% \end{figure}
% \begin{figure}[ht]\ContinuedFloat
%  \centering
% 	\parbox{0.325\textwidth}{
% 		\centering
% 		\includegraphics[width=\linewidth,page=56]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=71]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}
% 	}~
% 	\parbox{0.325\textwidth}{
% 		\centering
% 		\includegraphics[width=\linewidth,page=61]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=76]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}
% 	}%
% 	\parbox{0.325\textwidth}{
% 		\centering
% 		\includegraphics[width=\linewidth,page=66]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}\\
% 		\includegraphics[width=\linewidth,page=80]{graphics/correctionsToEff/TOF_tagAndProbe/correction/TofEffCorrection3D_pion.pdf}
% 	}%
% \end{figure}
